...
widgetRegistry.register(
	...
	function linklist( args ) {
		...
		$(target+' ul').append(
			'<li class="edit-element"><input type="text" name="url" class="additem" placeholder="URL (http://www.example.com/)" /><input type="text" name="Name" class="additem" placeholder="Name (Example Site)" /><button type="button" class="submitadd" title="Add Item"><img src="icons/plus.svg" alt="Add Item" /></button></li>'
		);
