...
widgetRegistry.register(
	...
	function search(args) {
		...
		$(args[0]).html('<form id="searchform" method="get" action="'+saction+'"><input name="'+queryname+'" id="s" type="text" placeholder="Search&#133;" /> <input value="Search" type="submit"></form><div class="edit-control edit-manipulate"></div>');
		return true;
	}
