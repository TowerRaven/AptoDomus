...
function initLocalStorage() {
	...
	if( (window.columns = getData('columns') ) == undefined ) {
		// Defaults
		setData('columns', '{"0":{"widget":"search","data":"google","width":"fullwidth"},"1":{"widget":"links","data":{"0":{"name":"Reddit","url":"http://reddit.com/"},"1":{"name":"ArsTechnica","url":"http://arstechnica.com/"},"2":{"name":"Tower Designs","url":"http://towerdesigns.co.uk/"}},"width":"onethird"},"2":{"widget":"intro","data":null,"width":"onethird"},"3":{"widget":"empty","data":null,"width":"onethird"},"4":{"widget":"news","data":{"url":"http://feeds.bbci.co.uk/news/rss.xml","style":"scroll"},"width":"fullwidth"}}');
