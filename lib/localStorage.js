...
function saveData(key, json) {
	...
	if(setData(key, jsonstr))
		...
		return false; // TODO Update with error output
}
...
function restoreSettings(newsettings) {
	...
	console.log(newsettings["title"] == undefined);
	console.log(newsettings["rows"] == undefined);
	console.log(newsettings["columns"] == undefined);
